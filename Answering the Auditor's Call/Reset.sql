...
delete from auditor.SQLInstances where collectiondate = '2025-11-20';
delete from auditor.BackupRestoreTests where collectiondate = '2025-11-20';
delete from auditor.AllCheckDBs where collectiondate = '2025-11-20';
delete from auditor.LastGoodCheckDB where collectiondate = '2025-11-20';
delete from auditor.BackupJobHistory where collectiondate = '2025-11-20';
delete from auditor.MSDBBackupHistory where collectiondate = '2025-11-20';
delete from auditor.LastBackups where collectiondate = '2025-11-20';
delete from auditor.AllPermissions where collectiondate = '2025-11-20';
delete from auditor.DatabaseRoleMembers where collectiondate = '2025-11-20';
delete from auditor.DatabaseRoles where collectiondate = '2025-11-20';
delete from auditor.DatabaseUsers where collectiondate = '2025-11-20';
delete from auditor.ServerRoleMembers where collectiondate = '2025-11-20';
delete from auditor.ServerRoles where collectiondate = '2025-11-20';
delete from auditor.InstanceLogins where collectiondate = '2025-11-20';
delete from auditor.DatabaseEncryption where collectiondate = '2025-11-20';
delete from auditor.DatabaseInventory where collectiondate = '2025-11-20';
delete from auditor.MasterDBCertificates where collectiondate = '2025-11-20';
delete from auditor.PatchLevels where collectiondate = '2025-11-20';
delete from auditor.ErrorLogPaths where collectiondate = '2025-11-20';
...
alter table auditor.SQLInstances add  collectiondate datetime null;
